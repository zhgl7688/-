...
using Fruit.Utils.ZipLib.Encryption;
#endif

using Fruit.Utils.ZipLib.Core;
using Fruit.Utils.ZipLib.Checksums;
using Fruit.Utils.ZipLib.Zip.Compression.Streams;
using Fruit.Utils.ZipLib.Zip.Compression;

namespace Fruit.Utils.ZipLib.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="Fruit.Utils.ZipLib.Zip.ZipException">
