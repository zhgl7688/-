...
namespace Fruit.Utils.Ionic.Zip
{
    /// <summary>
    ...
    public partial class ZipEntry
    {
        ...
        public ZipEntry()
        {
            ...
            _CompressionLevel = Fruit.Utils.Ionic.Zlib.CompressionLevel.Default;
        ...
        public DateTime LastModified
        {
            ...
            set
            {
                _LastModified = (value.Kind == DateTimeKind.Unspecified)
                    ...
                    : value.ToLocalTime();
                _Mtime = Fruit.Utils.Ionic.Zip.SharedUtilities.AdjustTime_Reverse(_LastModified).ToUniversalTime();
        ...
        /// <seealso cref="Fruit.Utils.Ionic.Zip.ZipEntry.LastModified"/>
        ...
        public CompressionMethod CompressionMethod
        {
            ...
            set
            {
                ...
                if (_CompressionMethod == (Int16)Fruit.Utils.Ionic.Zip.CompressionMethod.None)
                    _CompressionLevel = Fruit.Utils.Ionic.Zlib.CompressionLevel.None;
                else if (CompressionLevel == Fruit.Utils.Ionic.Zlib.CompressionLevel.None)
                    _CompressionLevel = Fruit.Utils.Ionic.Zlib.CompressionLevel.Default;
        ...
        ///
        /// <seealso cref="CompressionMethod"/>
        public Fruit.Utils.Ionic.Zlib.CompressionLevel CompressionLevel
        {
            get
            {
            ...
            set
            {
                ...
                if (value == Fruit.Utils.Ionic.Zlib.CompressionLevel.Default &&
                    _CompressionMethod == (short)CompressionMethod.Deflate) return; // nothing to do
                _CompressionLevel = value;

                if (value == Fruit.Utils.Ionic.Zlib.CompressionLevel.None &&
                    _CompressionMethod == (short)CompressionMethod.None)
                    return; // nothing more to do

                if (_CompressionLevel == Fruit.Utils.Ionic.Zlib.CompressionLevel.None)
                    _CompressionMethod = (short) Fruit.Utils.Ionic.Zip.CompressionMethod.None;
                else
                    _CompressionMethod = (short) Fruit.Utils.Ionic.Zip.CompressionMethod.Deflate;
        ...
        /// </remarks>
        ///
        /// <seealso cref="Fruit.Utils.Ionic.Zip.ZipEntry.UncompressedSize"/>
        ...
        /// </remarks>
        ///
        /// <seealso cref="Fruit.Utils.Ionic.Zip.ZipEntry.CompressedSize"/>
        ...
        /// </exception>
        ///
        /// <seealso cref="Fruit.Utils.Ionic.Zip.ZipEntry.Password">ZipEntry.Password</seealso>
        /// <seealso cref="Fruit.Utils.Ionic.Zip.ZipFile.Encryption">ZipFile.Encryption</seealso>
        ...
        /// </example>
        ///
        /// <seealso cref="Fruit.Utils.Ionic.Zip.ZipEntry.Encryption"/>
        /// <seealso cref="Fruit.Utils.Ionic.Zip.ZipFile.Password">ZipFile.Password</seealso>
        ...
        ///
        /// </remarks>
        /// <seealso cref="Fruit.Utils.Ionic.Zip.ZipFile.ExtractExistingFile"/>
        ///
        /// <example>
        ...
        ///
        /// </remarks>
        /// <seealso cref="Fruit.Utils.Ionic.Zip.ZipFile.ZipErrorAction"/>
        /// <seealso cref="Fruit.Utils.Ionic.Zip.ZipFile.ZipError"/>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    AlternateEncoding = Fruit.Utils.Ionic.Zip.ZipFile.DefaultEncoding;
                    AlternateEncodingUsage = ZipOption.Never;
                }
            }
        }
        ...
        private static ZipEntry Create(string nameInArchive, ZipEntrySource source, Object arg1, Object arg2)
        {
            if (String.IsNullOrEmpty(nameInArchive))
                throw new Fruit.Utils.Ionic.Zip.ZipException("The entry name must be non-null and non-empty.");
            ...
            else
            {
                ...
                if (String.IsNullOrEmpty(filename))
                    throw new Fruit.Utils.Ionic.Zip.ZipException("The filename must be non-null and non-empty.");
        ...
        private void SetFdpLoh()
        {
            ...
            try
            {
                ...
                // workitem 10178
                Fruit.Utils.Ionic.Zip.SharedUtilities.Workaround_Ladybug318918(this.ArchiveStream);
            }
        ...
        private Fruit.Utils.Ionic.Zlib.CompressionLevel _CompressionLevel;
