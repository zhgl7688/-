...
namespace Fruit.Utils.Ionic.Zip
{
    public partial class ZipEntry
    {
        ...
        private bool WantReadAgain()
        {
            ...
            if (CompressionLevel == Fruit.Utils.Ionic.Zlib.CompressionLevel.None) return false;
        ...
        private void MaybeUnsetCompressionMethodForWriting(int cycle)
        {
            ...
            if (CompressionLevel == (short)Fruit.Utils.Ionic.Zlib.CompressionLevel.None &&
                CompressionMethod == Fruit.Utils.Ionic.Zip.CompressionMethod.Deflate)
                _CompressionMethod = 0x00;
        ...
        internal void WriteHeader(Stream s, int cycle)
        {
            ...
            // LastMod
            _TimeBlob = Fruit.Utils.Ionic.Zip.SharedUtilities.DateTimeToPacked(LastModified);
        ...
        private Int32 FigureCrc32()
        {
            if (_crcCalculated == false)
            {
                ...
                {
                    var output = new Fruit.Utils.Ionic.Crc.CrcCalculatorStream(Stream.Null);
                ...
                else
                {
                    ...
                    var crc32 = new Fruit.Utils.Ionic.Crc.CRC32();
        ...
        private void _WriteEntryData(Stream s)
        {
            ...
            try
            {
                ...
                var output = new Fruit.Utils.Ionic.Crc.CrcCalculatorStream(compressor, true);
        ...
        internal void FinishOutputStream(Stream s,
                                         ...
                                         Stream encryptor,
                                         Stream compressor,
                                         Fruit.Utils.Ionic.Crc.CrcCalculatorStream output)
        {
            ...
            if ((compressor as Fruit.Utils.Ionic.Zlib.DeflateStream) != null)
                compressor.Close();
#if BZIP
...
#if !NETCF
            else if ((compressor as Fruit.Utils.Ionic.Zlib.ParallelDeflateOutputStream) != null)
                compressor.Close();
#endif
            ...
            if (_UncompressedSize == 0 && _CompressedSize == 0)
            {
                ...
                if (_Password != null)
                {
                    ...
                    if (Encryption != EncryptionAlgorithm.None)
                    {
                        ...
                        // workitem 10178
                        Fruit.Utils.Ionic.Zip.SharedUtilities.Workaround_Ladybug318918(s);
        ...
        internal void PrepOutputStream(Stream s,
                                       ...
                                       out Fruit.Utils.Ionic.Crc.CrcCalculatorStream output)
        {
            ...
            // Wrap a CrcCalculatorStream around that.
            // This will happen BEFORE compression (if any) as we write data out.
            output = new Fruit.Utils.Ionic.Crc.CrcCalculatorStream(compressor, true);
        }
        ...
        {
            if (_CompressionMethod == 0x08 && CompressionLevel != Fruit.Utils.Ionic.Zlib.CompressionLevel.None)
            {
#if !NETCF
                     ...
                     _container.ParallelDeflateThreshold > 0L))
                {
                    ...
                    if (_container.ParallelDeflater == null)
                    {
                        _container.ParallelDeflater =
                            new Fruit.Utils.Ionic.Zlib.ParallelDeflateOutputStream(s,
                                                                       CompressionLevel,
                                                                       _container.Strategy,
                                                                       true);
                    ...
                    Fruit.Utils.Ionic.Zlib.ParallelDeflateOutputStream o1 = _container.ParallelDeflater;
                    o1.Reset(s);
                    return o1;
                }
#endif
                var o = new Fruit.Utils.Ionic.Zlib.DeflateStream(s, Fruit.Utils.Ionic.Zlib.CompressionMode.Compress,
                                                     CompressionLevel,
                                                     true);
                if (_container.CodecBufferSize > 0)
