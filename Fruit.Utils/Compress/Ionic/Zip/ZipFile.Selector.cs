...
namespace Fruit.Utils.Ionic.Zip
{
    ...
    partial class ZipFile
    {
                                               ...
                                               bool wantUpdate)
        {
            ...
            Fruit.Utils.Ionic.FileSelector ff = new Fruit.Utils.Ionic.FileSelector(selectionCriteria,
...
namespace Fruit.Utils.Ionic
{
    internal abstract partial class SelectionCriterion
    {
        internal abstract bool Evaluate(Fruit.Utils.Ionic.Zip.ZipEntry entry);
    }


    internal partial class NameCriterion : SelectionCriterion
    {
        internal override bool Evaluate(Fruit.Utils.Ionic.Zip.ZipEntry entry)
        {
    ...
    {
        private bool Evaluate(Fruit.Utils.Ionic.Zip.ZipEntry entry)
        {
        ...
        public ICollection<Fruit.Utils.Ionic.Zip.ZipEntry> SelectEntries(Fruit.Utils.Ionic.Zip.ZipFile zip)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");

            var list = new List<Fruit.Utils.Ionic.Zip.ZipEntry>();

            foreach (Fruit.Utils.Ionic.Zip.ZipEntry e in zip)
            {
                if (this.Evaluate(e))
                    list.Add(e);
            }
        ...
        ///
        /// <returns>a collection of ZipEntry objects that conform to the criteria.</returns>
        public ICollection<Fruit.Utils.Ionic.Zip.ZipEntry> SelectEntries(Fruit.Utils.Ionic.Zip.ZipFile zip, string directoryPathInArchive)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");
