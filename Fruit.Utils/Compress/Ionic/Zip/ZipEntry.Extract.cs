...
namespace Fruit.Utils.Ionic.Zip
{
    ...
    public partial class ZipEntry
    {
        ...
        ///
        /// <seealso cref="Fruit.Utils.Ionic.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="Fruit.Utils.Ionic.Zip.ZipEntry.Extract(string, ExtractExistingFileAction)"/>
        ///
        /// <example>
        ...
        ///
        /// <seealso cref="Fruit.Utils.Ionic.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="Fruit.Utils.Ionic.Zip.ZipEntry.ExtractWithPassword(ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        ///
        /// <para>
        ...
        ///   cref="Fruit.Utils.Ionic.Zip.ZipEntry.ExtractExistingFile"/>property, or call
        ///   <see
        ...
        ///
        /// <seealso cref="Fruit.Utils.Ionic.Zip.ZipEntry.ExtractExistingFile"/>
        /// <seealso cref="Fruit.Utils.Ionic.Zip.ZipEntry.ExtractWithPassword(string, ExtractExistingFileAction, string)"/>
        ///
        /// <remarks>
        /// <para>
        ///   Existing entries in the filesystem will not be overwritten. If you
        ...
        ///   cref="Fruit.Utils.Ionic.Crc.CrcCalculatorStream"/>.  Use it as you would any
        ...
        ///   cref="Fruit.Utils.Ionic.Crc.CrcCalculatorStream.Crc"/> property on the
        ...
        /// </code>
        /// </example>
        /// <seealso cref="Fruit.Utils.Ionic.Zip.ZipEntry.Extract(System.IO.Stream)"/>
        /// <returns>The Stream for reading.</returns>
        public Fruit.Utils.Ionic.Crc.CrcCalculatorStream OpenReader()
        {
            // workitem 10923
        ...
        /// <param name="password">The password to use for decrypting the entry.</param>
        /// <returns>The Stream for reading.</returns>
        public Fruit.Utils.Ionic.Crc.CrcCalculatorStream OpenReader(string password)
        {
            // workitem 10923
            if (_container.ZipFile == null)
                throw new InvalidOperationException("Use OpenReader() only with ZipFile.");
        ...
        internal Fruit.Utils.Ionic.Crc.CrcCalculatorStream InternalOpenReader(string password)
        {
            ValidateCompression();
            ValidateEncryption();
            ...
            return new Fruit.Utils.Ionic.Crc.CrcCalculatorStream(input3, LeftToRead);
        }
        ...
        private Int32 ExtractOne(Stream output)
        {
            ...
            try
            {
                ...
                // workitem 10178
                Fruit.Utils.Ionic.Zip.SharedUtilities.Workaround_Ladybug318918(input);
                ...
                using (var s1 = new Fruit.Utils.Ionic.Crc.CrcCalculatorStream(input3))
                {
                    while (LeftToRead > 0)
                    {
        ...
        internal Stream GetExtractDecompressor(Stream input2)
        {
            ...
            switch (_CompressionMethod_FromZipFile)
            {
                ...
                case (short)CompressionMethod.Deflate:
                    return new Fruit.Utils.Ionic.Zlib.DeflateStream(input2, Fruit.Utils.Ionic.Zlib.CompressionMode.Decompress, true);
#if BZIP
        ...
        internal void _SetTimes(string fileOrDirectory, bool isFile)
        {
            ...
            try
            {
                ...
                {
                    // workitem 6191
                    DateTime AdjustedLastModified = Fruit.Utils.Ionic.Zip.SharedUtilities.AdjustTime_Reverse(LastModified);
