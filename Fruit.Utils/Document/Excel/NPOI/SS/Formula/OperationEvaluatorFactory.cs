...
namespace Fruit.Utils.NPOI.SS.Formula
{
    ...
    using Fruit.Utils.NPOI.SS.Formula.Functions;
    ...
    class OperationEvaluatorFactory
    {
        ...
        private static void Add(Hashtable m, OperationPtg ptgKey,
            Fruit.Utils.NPOI.SS.Formula.Functions.Function instance)
        {
                ...
                OperationEvaluationContext ec)
        {
            ...
            Fruit.Utils.NPOI.SS.Formula.Functions.Function result = _instancesByPtgClass[ptg] as Fruit.Utils.NPOI.SS.Formula.Functions.Function;
            ...
            if (ptg is AbstractFunctionPtg)
            {
                ...
                {
                    case Fruit.Utils.NPOI.SS.Formula.Function.FunctionMetadataRegistry.FUNCTION_INDEX_INDIRECT:
                        return Indirect.instance.Evaluate(args, ec);
                    case Fruit.Utils.NPOI.SS.Formula.Function.FunctionMetadataRegistry.FUNCTION_INDEX_EXTERNAL:
