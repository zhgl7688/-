...
namespace Fruit.Utils.NPOI.HSSF.UserModel
{
    ...
    /// </summary> 
    [Serializable]
    public class HSSFRichTextString : IComparable<HSSFRichTextString>,Fruit.Utils.NPOI.SS.UserModel.IRichTextString
    {
        ...
        public void ApplyFont(int startIndex, int endIndex, Fruit.Utils.NPOI.SS.UserModel.IFont font)
        {
        ...
        public void ApplyFont(Fruit.Utils.NPOI.SS.UserModel.IFont font)
        {
