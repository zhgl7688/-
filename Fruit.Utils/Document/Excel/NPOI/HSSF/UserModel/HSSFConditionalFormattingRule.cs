...
namespace Fruit.Utils.NPOI.HSSF.UserModel
{
    ...
    using Fruit.Utils.NPOI.HSSF.Record.CF;
        ...
        public String Formula2
        {
            get
            {
                ...
                if (conditionType == CELL_COMPARISON)
                {
                    ...
                    {
                        case (byte)Fruit.Utils.NPOI.SS.UserModel.ComparisonOperator.BETWEEN:
                        case (byte)Fruit.Utils.NPOI.SS.UserModel.ComparisonOperator.NOT_BETWEEN:
