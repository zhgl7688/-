...
namespace Fruit.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFWorkbook : POIDocument, IWorkbook
    {
        ...
        public Fruit.Utils.NPOI.SS.UserModel.ICreationHelper GetCreationHelper()
        {
        ...
        /// </summary>
        private class SheetRecordCollector : Fruit.Utils.NPOI.HSSF.Record.Aggregates.RecordVisitor,IDisposable
        {
     ...
     */
        ...
        [NonSerialized]
        private Fruit.Utils.NPOI.SS.UserModel.MissingCellPolicy missingCellPolicy = Fruit.Utils.NPOI.SS.UserModel.MissingCellPolicy.RETURN_NULL_AND_BLANK;
        /// <summary>
        ...
        public Fruit.Utils.NPOI.SS.UserModel.MissingCellPolicy MissingCellPolicy
        {
        ...
        public Fruit.Utils.NPOI.SS.UserModel.ISheet GetSheetAt(int index)
        {
        ...
        public Fruit.Utils.NPOI.SS.UserModel.ISheet GetSheet(String name)
        {
                                               ...
                                               int startRow, int endRow)
        {
            ...
            Fruit.Utils.NPOI.SS.UserModel.IPrintSetup printSetup = sheet.PrintSetup;
        ...
        public Fruit.Utils.NPOI.SS.UserModel.IFont CreateFont()
        {
        ...
        /// <returns></returns>
        public Fruit.Utils.NPOI.SS.UserModel.IFont FindFont(short boldWeight, short color, short fontHeight,
                         String name, bool italic, bool strikeout,
                         short typeOffset, byte Underline)
        {
            ...
            for (short i = 0; i <= this.NumberOfFonts; i++)
            {
                ...
                Fruit.Utils.NPOI.SS.UserModel.IFont hssfFont = GetFontAt(i);
        ...
        public Fruit.Utils.NPOI.SS.UserModel.IFont GetFontAt(short idx)
        {
        ...
        public Fruit.Utils.NPOI.SS.UserModel.ICellStyle CreateCellStyle()
        {
        ...
        public Fruit.Utils.NPOI.SS.UserModel.ICellStyle GetCellStyleAt(short idx)
        {
 ...
 */
        ...
        public Fruit.Utils.NPOI.SS.UserModel.IName GetName(String name)
        {
        ...
        public Fruit.Utils.NPOI.SS.UserModel.IName GetNameAt(int index)
        {
        ...
        /// </summary>
        /// <returns>named range high level</returns>
        public Fruit.Utils.NPOI.SS.UserModel.IName CreateName()
        {
        ...
        public Fruit.Utils.NPOI.SS.UserModel.IDataFormat CreateDataFormat()
        {
            if (formatter == null)
        ...
        public int AddPicture(byte[] pictureData, Fruit.Utils.NPOI.SS.UserModel.PictureType format)
        {
            InitDrawings();
            ...
            switch (format)
            {
                case Fruit.Utils.NPOI.SS.UserModel.PictureType.EMF:
                    blipRecord.Options = HSSFPictureData.MSOBI_EMF;
                    break;
                case Fruit.Utils.NPOI.SS.UserModel.PictureType.WMF:
                    blipRecord.Options = HSSFPictureData.MSOBI_WMF;
                    break;
                case Fruit.Utils.NPOI.SS.UserModel.PictureType.PICT:
                    blipRecord.Options = HSSFPictureData.MSOBI_PICT;
                    break;
                case Fruit.Utils.NPOI.SS.UserModel.PictureType.PNG:
                    blipRecord.Options = HSSFPictureData.MSOBI_PNG;
                    break;
                case Fruit.Utils.NPOI.SS.UserModel.PictureType.JPEG:
                    blipRecord.Options = HSSFPictureData.MSOBI_JPEG;
                    break;
                case Fruit.Utils.NPOI.SS.UserModel.PictureType.DIB:
