...
namespace Fruit.Utils.NPOI.HSSF.UserModel
{
    ...
    /// </summary>
    public class HSSFPrintSetup :Fruit.Utils.NPOI.SS.UserModel.IPrintSetup
    {
        ...
        public Fruit.Utils.NPOI.SS.UserModel.DisplayCellErrorType CellError
        {
            get { return (Fruit.Utils.NPOI.SS.UserModel.DisplayCellErrorType)printSetupRecord.CellError; }
