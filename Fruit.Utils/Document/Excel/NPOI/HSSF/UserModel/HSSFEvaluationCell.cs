...
namespace Fruit.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFEvaluationCell : IEvaluationCell
    {
        ...
        private Fruit.Utils.NPOI.SS.UserModel.ICell _cell;
        ...
        public Fruit.Utils.NPOI.SS.UserModel.ICell HSSFCell
        {
            get
            {
                return _cell;
        ...
        public Fruit.Utils.NPOI.SS.UserModel.CellType CellType
        {
            get
            {
