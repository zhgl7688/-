...
namespace Fruit.Utils.NPOI.HSSF.UserModel
{
    using System;
    using System.Collections;
    using System.Collections.Generic;
    using System.Windows.Forms;
    using Fruit.Utils.NPOI.DDF;
    using Fruit.Utils.NPOI.HSSF.Model;
    using Fruit.Utils.NPOI.HSSF.Record;
    using Fruit.Utils.NPOI.HSSF.Record.Aggregates;
    using Fruit.Utils.NPOI.HSSF.Record.AutoFilter;
    using Fruit.Utils.NPOI.HSSF.Util;
    using Fruit.Utils.NPOI.SS;
    using Fruit.Utils.NPOI.SS.Formula;
    using Fruit.Utils.NPOI.SS.Formula.PTG;
    using Fruit.Utils.NPOI.SS.UserModel;
    using Fruit.Utils.NPOI.SS.Util;
    ...
    /// </remarks>
    [Serializable]
    public class HSSFSheet : Fruit.Utils.NPOI.SS.UserModel.ISheet
    {
        ...
        private Dictionary<int, Fruit.Utils.NPOI.SS.UserModel.IRow> rows;
        ...
        /// <see cref="Fruit.Utils.NPOI.HSSF.UserModel.HSSFWorkbook.CreateSheet()"/>
        public HSSFSheet(HSSFWorkbook workbook)
        {
            _sheet = InternalSheet.CreateSheet();
            rows = new Dictionary<int, Fruit.Utils.NPOI.SS.UserModel.IRow>();
        ...
        /// <see cref="Fruit.Utils.NPOI.HSSF.UserModel.HSSFWorkbook(Fruit.Utils.NPOI.POIFS.FileSystem.DirectoryNode, bool)"/>
        ...
        public Fruit.Utils.NPOI.SS.UserModel.IRow CreateRow(int rownum)
        {
        ...
        private int FindLastRow(int lastrow)
        {
            ...
            Fruit.Utils.NPOI.SS.UserModel.IRow r = GetRow(rownum);
        ...
        /// <returns></returns>
        public Fruit.Utils.NPOI.SS.UserModel.ICellStyle GetColumnStyle(int column)
        {
        ...
        public Fruit.Utils.NPOI.SS.UserModel.IRow GetRow(int rowIndex)
        {
        ...
        [Obsolete]
        public int AddMergedRegion(Fruit.Utils.NPOI.SS.Util.Region region)
        {
        ...
        /// <returns>index of this region</returns>
        public int AddMergedRegion(Fruit.Utils.NPOI.SS.Util.CellRangeAddress region)
        {
        ...
        /// Call <see cref="Fruit.Utils.NPOI.SS.UserModel.IRow.RowNum"/> on each row 
        ...
        public Fruit.Utils.NPOI.SS.UserModel.IPrintSetup PrintSetup
        {
        ...
        public Fruit.Utils.NPOI.SS.UserModel.IHeader Header
        {
        ...
        public Fruit.Utils.NPOI.SS.UserModel.IFooter Footer
        {
        ...
        public void SetEnclosedBorderOfRegion(CellRangeAddress region, Fruit.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderRightOfRegion(CellRangeAddress region, Fruit.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetRightBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderRight(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderLeftOfRegion(CellRangeAddress region, Fruit.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetLeftBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderLeft(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderTopOfRegion(CellRangeAddress region, Fruit.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetTopBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderTop(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderBottomOfRegion(CellRangeAddress region, Fruit.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetBottomBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderBottom(borderType, region, this, _workbook);
        }
        ...
        protected void ShiftMerged(int startRow, int endRow, int n, bool IsRow)
        {
            ...
            {
                Fruit.Utils.NPOI.SS.Util.CellRangeAddress merged = this.GetMergedRegion(i);
            ...
            {
                Fruit.Utils.NPOI.SS.Util.CellRangeAddress region = (Fruit.Utils.NPOI.SS.Util.CellRangeAddress)iterator.Current;
        ...
        [Obsolete]
        private static bool ContainsCell(Fruit.Utils.NPOI.SS.Util.CellRangeAddress cr, int rowIx, int colIx)
        {
            ...
            bool copyRowHeight, bool resetOriginalRowHeight, bool moveComments)
        {
            ...
            for (int rowNum = s; rowNum >= startRow && rowNum <= endRow && rowNum >= 0 && rowNum < 65536; rowNum += inc)
            {
                ...
                foreach (ICell cell in cells)
                {
                    ...
                    Fruit.Utils.NPOI.SS.UserModel.IHyperlink link = cell.Hyperlink;
                    if (link != null)
                    {
        ...
        public void CreateSplitPane(int xSplitPos, int ySplitPos, int leftmostColumn, int topRow, Fruit.Utils.NPOI.SS.UserModel.PanePosition activePane)
        ...
        public Fruit.Utils.NPOI.SS.Util.PaneInformation PaneInformation
        {
            get
            {
        ...
        public double GetMargin(Fruit.Utils.NPOI.SS.UserModel.MarginType margin)
        {
        ...
        public void SetMargin(Fruit.Utils.NPOI.SS.UserModel.MarginType margin, double size)
        {
        ...
        public Fruit.Utils.NPOI.SS.UserModel.IDrawing CreateDrawingPatriarch()
        {
            if (_patriarch == null)
            {
        ...
        public void SetDefaultColumnStyle(int column, Fruit.Utils.NPOI.SS.UserModel.ICellStyle style)
        {
        ...
        public IComment GetCellComment(int row, int column)
        {
            ...
            if (r != null)
            {
                Fruit.Utils.NPOI.SS.UserModel.ICell c = r.GetCell(column);
                if (c != null)
                {
        ...
        /// </summary>
        public Fruit.Utils.NPOI.SS.UserModel.IWorkbook Workbook
        {
            get
            {
                return _workbook;
        ...
        public String SheetName
        {
            get
            {
                Fruit.Utils.NPOI.SS.UserModel.IWorkbook wb = Workbook;
