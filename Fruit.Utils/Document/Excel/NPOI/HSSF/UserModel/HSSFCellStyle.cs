...
namespace Fruit.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFCellStyle : ICellStyle
    {
        ...
        private Fruit.Utils.NPOI.HSSF.Model.InternalWorkbook workbook = null;
        ...
        /// <param name="rec">The record.</param>
        /// <param name="workbook">The workbook.</param>
        public HSSFCellStyle(short index, ExtendedFormatRecord rec, Fruit.Utils.NPOI.HSSF.Model.InternalWorkbook workbook)
        {
        ...
        public void SetFont(Fruit.Utils.NPOI.SS.UserModel.IFont font)
        {
