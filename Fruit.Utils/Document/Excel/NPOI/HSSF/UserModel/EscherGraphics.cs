...
namespace Fruit.Utils.NPOI.HSSF.UserModel
{
    ...
    public class EscherGraphics : IDisposable
    {
        ...
        private HSSFFont MatchFont(Font font)
        {
            ...
            HSSFFont hssfFont = (HSSFFont)workbook.FindFont(bold ? (short)Fruit.Utils.NPOI.SS.UserModel.FontBoldWeight.BOLD : (short)Fruit.Utils.NPOI.SS.UserModel.FontBoldWeight.NORMAL,
                        hssfColor.GetIndex(),
                        (short)(font.Size * 20),
                        font.Name,
                        italic,
                        false,
                        (short)Fruit.Utils.NPOI.SS.UserModel.FontSuperScript.NONE,
                        (byte)Fruit.Utils.NPOI.SS.UserModel.FontUnderlineType.NONE
                        );
            if (hssfFont == null)
            {
                hssfFont = (HSSFFont)workbook.CreateFont();
                hssfFont.Boldweight = (short)(bold ? Fruit.Utils.NPOI.SS.UserModel.FontBoldWeight.BOLD : 0);
