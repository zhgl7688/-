...
namespace Fruit.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFName:Fruit.Utils.NPOI.SS.UserModel.IName
    {
        ...
        public String RefersToFormula
        {
            ...
            set
            {
                Ptg[] ptgs = HSSFFormulaParser.Parse(value, book, Fruit.Utils.NPOI.SS.Formula.FormulaType.NAMEDRANGE, SheetIndex);
