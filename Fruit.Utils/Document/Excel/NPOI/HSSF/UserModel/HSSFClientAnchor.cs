...
namespace Fruit.Utils.NPOI.HSSF.UserModel
{
    ...
    /// </summary>
    public class HSSFClientAnchor : HSSFAnchor, Fruit.Utils.NPOI.SS.UserModel.IClientAnchor
    {
        int col1;
        int row1;
        int col2;
        ...
        public float GetAnchorHeightInPoints(Fruit.Utils.NPOI.SS.UserModel.ISheet sheet)
        {
            int y1 = Dy1;
            int y2 = Dy2;
        ...
        /// <returns></returns>
        private float GetRowHeightInPoints(Fruit.Utils.NPOI.SS.UserModel.ISheet sheet, int rowNum)
        {
            Fruit.Utils.NPOI.SS.UserModel.IRow row = sheet.GetRow(rowNum);
            if (row == null)
