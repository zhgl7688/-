...
namespace Fruit.Utils.NPOI.HSSF.Record.Aggregates
{
 ...
 */
        ...
        public void SetArrayFormula(CellRangeAddress r, Ptg[] ptgs)
        {
            ...
            ArrayRecord arr = new ArrayRecord(Fruit.Utils.NPOI.SS.Formula.Formula.Create(ptgs), new CellRangeAddress8Bit(r.FirstRow, r.LastRow, r.FirstColumn, r.LastColumn));
