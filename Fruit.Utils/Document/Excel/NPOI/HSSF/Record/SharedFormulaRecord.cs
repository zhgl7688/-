...
namespace Fruit.Utils.NPOI.HSSF.Record
{
    ...
    public class SharedFormulaRecord : SharedValueRecordBase
    {
        ...
        private Fruit.Utils.NPOI.SS.Formula.Formula field_7_parsed_expr;
            ...
            : base(in1)
        {
            ...
            field_7_parsed_expr = Fruit.Utils.NPOI.SS.Formula.Formula.Read(field_6_expression_len, in1, nAvailableBytes);
        }
