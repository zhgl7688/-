...
namespace Fruit.Utils.NPOI.HSSF.Record
{
    ...
    public class ArrayRecord : SharedValueRecordBase
    {
        ...
        private Fruit.Utils.NPOI.SS.Formula.Formula _formula;
            ...
            : base(in1)
        {
		    ...
		    _formula = Fruit.Utils.NPOI.SS.Formula.Formula.Read(formulaTokenLen, in1, totalFormulaLen);
        }
        public ArrayRecord(Fruit.Utils.NPOI.SS.Formula.Formula formula, CellRangeAddress8Bit range):base(range)
        {
