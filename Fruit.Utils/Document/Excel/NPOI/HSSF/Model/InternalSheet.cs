...
namespace Fruit.Utils.NPOI.HSSF.Model
{
    using System;
    ...
    public class InternalSheet
    {
        ...
        /// </summary>
        /// <see cref="Fruit.Utils.NPOI.HSSF.Record.DefaultRowHeightRecord"/>
        /// <see cref="Fruit.Utils.NPOI.HSSF.Record.Record"/>
 ...
 */
         ...
         */
        public void CreateSplitPane(int xSplitPos, int ySplitPos, int topRow, int leftmostColumn, Fruit.Utils.NPOI.SS.UserModel.PanePosition activePane)
        {
            int paneLoc = FindFirstRecordLocBySid(PaneRecord.sid);
            if (paneLoc != -1)
                records.RemoveAt(paneLoc);
            ...
            SelectionRecord sel = (SelectionRecord)FindFirstRecordBySid(SelectionRecord.sid);
            sel.Pane = (byte)Fruit.Utils.NPOI.SS.UserModel.PanePosition.LOWER_RIGHT;
        ...
        public PaneInformation PaneInformation
        {
            get
            {
                ...
                return new Fruit.Utils.NPOI.SS.Util.PaneInformation(rec.X, rec.Y, rec.TopRow,
