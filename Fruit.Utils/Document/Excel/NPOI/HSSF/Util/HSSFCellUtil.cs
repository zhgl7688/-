...
namespace Fruit.Utils.NPOI.HSSF.Util
{
    using System;
    ...
    public class HSSFCellUtil
    {
         ...
         */
        public static void SetCellStyleProperty(Fruit.Utils.NPOI.SS.UserModel.ICell cell, HSSFWorkbook workbook, String propertyName, Object propertyValue)
        {
            Fruit.Utils.NPOI.SS.UserModel.ICellStyle originalStyle = cell.CellStyle;
            Fruit.Utils.NPOI.SS.UserModel.ICellStyle newStyle = null;
            ...
            {
                Fruit.Utils.NPOI.SS.UserModel.ICellStyle wbStyle = workbook.GetCellStyleAt(i);
        ...
        private static Hashtable GetFormatProperties(Fruit.Utils.NPOI.SS.UserModel.ICellStyle style)
        {
        ...
        private static void SetFormatProperties(
                Fruit.Utils.NPOI.SS.UserModel.ICellStyle style, HSSFWorkbook workbook, Hashtable properties)
        {
            style.Alignment = (Fruit.Utils.NPOI.SS.UserModel.HorizontalAlignment)GetShort(properties, ALIGNMENT);
            style.BorderBottom = (Fruit.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_BOTTOM);
            style.BorderLeft = (Fruit.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_LEFT);
            style.BorderRight = (Fruit.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_RIGHT);
            style.BorderTop = (Fruit.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_TOP);
            ...
            style.FillPattern = (Fruit.Utils.NPOI.SS.UserModel.FillPatternType)GetShort(properties, FILL_PATTERN);
            ...
            style.VerticalAlignment = (Fruit.Utils.NPOI.SS.UserModel.VerticalAlignment)GetShort(properties, VERTICAL_ALIGNMENT);
