...
{
    public partial class SetparamController : Controller
    {
    ...
    public partial class SetparamApiController : ApiController
    {
        ...
        public object Get()
        {
            ...
            using (var db = new LUOLAI1401Context())
            {
                return pageReq.ToPageList<BD_SysParasListModel>(db.Database, "a.FID ,a.certEx ,a.bidEx ,a.certEx2 ", "BD_SysParas a ", sbCondition.ToString(), "a.FID", "desc");
            }
        }
